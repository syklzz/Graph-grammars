...
def _create_base_graph() -> nx.Graph:
    ...
    """
    corner_and_hanging_nodes_edge_list = [
        (1, 6),
        (6, 2),
        (2, 5),
        (5, 3),
...
def _apply_production(graph: Graph, subgraph: Subgraph) -> None:
    ...
    new_inner_edges = [
        Edge(n1=middle_node, n2=h_node, b=0)
...
def _find_adjoining_nodes(node: Node, edges: List[Edge]) -> List[Node]:
    return [
        edge.n1 if edge.n2 == node else edge.n2
        for edge in edges
        if node in (edge.n1, edge.n2)
    ]
...
#     names = [
#         "left side of P3",
#         "complex graph with match",
#         "complex graph without match",
#         "Wrong label",
#         "Wrong r",
#         "Wrong h",
#     ]
#     test_graphs = [
#         exact_left_side(),
#         complex_graph_with_match(),
#         graph_with_no_match(),
#         graph_wrong_label(),
#         graph_wrong_r(),
#         graph_wrong_hanging_node(),
#     ]
